...
<div id="right">
	...
	<?php
 session_start(); if(!isset($_SESSION['user'])){ echo "<script>alert('请先登录');</script>"; echo "<script>location.href='/zfApp/admin/index.php';</script>"; }else{ if(count($ret)==0){ echo "<br/>暂无热销商品"; }else{ ?>
