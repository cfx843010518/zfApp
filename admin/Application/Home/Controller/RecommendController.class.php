...
class RecommendController extends Controller{
	...
	public function showRecPro(){
		...
		$rs = $recommendModel->where($condition)->limit($start,$size)->select();//调用分页方法
