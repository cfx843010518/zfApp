...
<tr>
  ...
  <td width="241"  bgcolor="#FFFFFF">&nbsp;
	<?php 
			$photos = explode("/",$rs['fly_photo']);
			//var_dump($photos);
			for($i=0;$i<count($photos)-3;$i++){
		?>
			<img src="__PUBLIC__/images/fly/<?php echo $photos[$i];?>" height="200px;">
		<?php	
			}
		?>
...
<tr>
	...
	<td width="241"  bgcolor="#FFFFFF">&nbsp;
		<?php 
			$photos = explode("/",$rs['product_image']);
			//var_dump($photos);
			for($i=0;$i<count($photos)-1;$i++){
		?>
			<img src="__PUBLIC__/images/product/<?php echo $photos[$i];?>" height="200px;">
		<?php	
			}
		?>
	</td> 
