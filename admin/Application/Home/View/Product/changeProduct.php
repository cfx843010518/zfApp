...
<div id="right" >
	...
	<form action="__APP__/Product/changeProduct" method="post" onsubmit="return sjyz(this)" enctype="multipart/form-data">
	...
	if(!isset($_SESSION['user'])){
		...
		for($i=0;$i<count($types);$i++){	//循环打印出字段值
			$pro_type_id = $types[$i]['pro_type_id'];
			$pro_type_name = $types[$i]['pro_type_name'];
	?>
